...
try:
    ...
    d = api('/v1/betaAppReviewSubmissions?filter[build]=02593383-34c3-4df0-b5bd-4dbfdc5c1d4e&limit=5')
...
<h1 style="color:#1a5c38">Build 42 reached the family</h1>
<p>Apple approved the beta - the family can install the real app right now.</p>
<p>This one is your follow up fix:</p>
<ul>
<li>Made the Concede, Leave Game, and Save and Leave popups bigger so they are easier to read, still fully on screen.</li>
</ul>
...
<p>- Cortana</p></div>''')
    subprocess.run(['python3', '/Users/jarvis/clawd/gmail_sa.py', 'send',
                    ...
                    'NASTY: build 42 is live for the family', body], check=True)
