...
try:
    ...
    d = api('/v1/betaAppReviewSubmissions?filter[build]=6c03f40a-a263-4474-8ba2-8fe7b4debad8&limit=5')
...
<h1 style="color:#1a5c38">🎉 Build 13 reached the family</h1>
...
<p>— Cortana</p></div>''')
    subprocess.run(['python3', '/Users/jarvis/clawd/gmail_sa.py', 'send',
                    ...
                    'NASTY: build 13 is live for the family 🎉', body], check=True)
