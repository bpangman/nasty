...
try:
    ...
    d = api('/v1/betaAppReviewSubmissions?filter[build]=54962bdc-b169-465e-ad76-8f5d59c1b680&limit=5')
...
<h1 style="color:#1a5c38">Build 41 reached the family</h1>
<p>Apple approved the beta - the family can install the real app right now.</p>
<p>This one is your follow up fix:</p>
<ul>
<li>The Concede, Leave Game, and Save and Leave popups now fit fully on screen with room to spare, nothing cut off.</li>
</ul>
...
<p>- Cortana</p></div>''')
    subprocess.run(['python3', '/Users/jarvis/clawd/gmail_sa.py', 'send',
                    ...
                    'NASTY: build 41 is live for the family', body], check=True)
