...
try:
    ...
    d = api('/v1/betaAppReviewSubmissions?filter[build]=e19eacc4-73dc-46d4-90cc-6af86e166d39&limit=5')
...
<h1 style="color:#1a5c38">🎉 Build 11 reached the family</h1>
...
<p>— Cortana</p></div>''')
    subprocess.run(['python3', '/Users/jarvis/clawd/gmail_sa.py', 'send',
                    ...
                    'NASTY: build 11 is live for the family 🎉', body], check=True)
