...
try:
    ...
    d = api('/v1/betaAppReviewSubmissions?filter[build]=c3c7d4fd-034b-4da0-baf6-37eab8ed08c0&limit=5')
...
<h1 style="color:#1a5c38">🎉 Build 12 reached the family</h1>
...
<p>— Cortana</p></div>''')
    subprocess.run(['python3', '/Users/jarvis/clawd/gmail_sa.py', 'send',
                    ...
                    'NASTY: build 12 is live for the family 🎉', body], check=True)
